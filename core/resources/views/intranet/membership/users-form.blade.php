...
@section('content')
    ...
    <section class="content">
        <div class="container-fluid">
            <div class="row">
                <div class="col-12">
                    <form class="form-horizontal" method="post" action="{{ url("intranet/membership/users/{$item->id}") }}">
                        {{ Form::token() }}
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-9">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        <label for="rolesCheckbox">Roles @if ($errors->has('roles')) <small class="text-danger">({!! $errors->first('roles') !!})</small>@endif</label>
                                                        {{ Form::select('roles[]', $roles->pluck('name_friendly', 'name'), old('roles[]', $item->roles->pluck('name')->toArray()), ['class' => 'form-control select2', 'style' => 'width: 100%', 'multiple']) }}
