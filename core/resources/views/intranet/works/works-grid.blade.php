...
@section('meta_title', 'Trabajos')
@section('meta_description', 'Trabajos')

@section('content-message')
@stop

@section('content-title')
    <a href="{{ url('intranet/works') }}" class="nav-link">Trabajos</a>
@stop
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            ...
                            @canany(['works.create'])
                            <a href="{{ url('intranet/works/create') }}" class="btn btn-light btn-sm float-right"><i class="fas fa-plus"></i> Añadir</a>
                            @endcanany
                        </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="btn-group btn-group-sm" role="group" aria-label="Basic example">
                                            @canany(['works.update'])
                                            <a href="{{ url("intranet/works/{$item->id}") }}" class="btn btn-light"><i class="fas fa-pencil-alt"></i></a>
                                            @endcanany
                                            @canany(['works.delete'])
                                            <a href="{{ url("intranet/works/{$item->id}/delete") }}" class="btn btn-light btnDelete"><i class="fas fa-trash"></i></a>
                                            @endcanany
                                        </div>
                                    </td>
                                </tr>
