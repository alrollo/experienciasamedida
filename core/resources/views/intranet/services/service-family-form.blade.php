...
@section('content')
    ...
    <section class="content">
        <div class="container-fluid">
            <div class="row">
                <div class="col-12">
                    <form class="form-horizontal" method="post" action="{{ url("intranet/services-families/$item->id") }}">
                        {{ Form::token() }}
                                                ...
                                                <div class="col-12 col-md-2 file-entity UploadImage"
                                                    ...
                                                    <div class="image-entity">
                                                        ...
                                                        <div class="image-container">
                                                            @if ($tagImage)
                                                                <a href="{{ asset('storage/servicefamily/'.$tagImage->attachable_id.'/'.$tagImage->file_name) }}" target="_blank"><img src="{{ asset('storage/servicefamily/'.$tagImage->attachable_id.'/'.$tagImage->file_name) }}" class="img-fluid"></a>
                                                            @else
...
@section('js')
    <script src="{{ asset('assets/js/intranet/services/ProductFamilyForm.js') }}" type="module"></script>
@stop
