...
@section('meta_description', 'Noticias')
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            ...
                            @canany(['news.create'])
                            <a href="{{ url('intranet/news/create') }}" class="btn btn-light btn-sm float-right"><i class="fas fa-plus"></i> Añadir</a>
                            @endcanany
                        </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="btn-group btn-group-sm" role="group" aria-label="Basic example">
                                            @canany(['news.update'])
                                            <a href="{{ url("intranet/news/{$item->id}") }}" class="btn btn-light"><i class="fas fa-pencil-alt"></i></a>
                                            @endcanany
                                            @canany(['news.delete'])
                                            <a href="{{ url("intranet/news/{$item->id}/delete") }}" class="btn btn-light btnDelete"><i class="fas fa-trash"></i></a>
                                            @endcanany
                                        </div>
                                    </td>
                                </tr>
