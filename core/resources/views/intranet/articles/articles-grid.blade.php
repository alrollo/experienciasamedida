...
@section('meta_title', 'Artículos')
@section('meta_description', 'Artículos')

@section('content-message')
@stop

@section('content-title')
    <a href="{{ url('intranet/articles') }}" class="nav-link">Artículos</a>
@stop
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            ...
                            @canany(['articles.create'])
                            <a href="{{ url('intranet/articles/create') }}" class="btn btn-light btn-sm float-right"><i class="fas fa-plus"></i> Añadir</a>
                            @endcanany
                        </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="btn-group btn-group-sm" role="group" aria-label="Basic example">
                                            @canany(['articles.update'])
                                            <a href="{{ url("intranet/articles/{$item->id}") }}" class="btn btn-light"><i class="fas fa-pencil-alt"></i></a>
                                            @endcanany
                                            @canany(['articles.delete'])
                                            <a href="{{ url("intranet/articles/{$item->id}/delete") }}" class="btn btn-light btnDelete"><i class="fas fa-trash"></i></a>
                                            @endcanany
                                        </div>
                                    </td>
                                </tr>
